...
public class HomePage extends BaseClass{
	...
	public HomePage() {
		...
		/*PageFactory is a class provided by Selenium Web driver to support 
		PAGE OBJECT PATTERN. In pageFactory,testers use @FindBy annotation.initElements method is used to initialize web elements.*/
